...
function Science() {
  ...
  const fetchItem = (page) => {
    axios
      .get(
        `https://api.themoviedb.org/3/discover/movie?api_key=86ecab01572806c443d2d6f0ebec2d77&page=${page+1}&with_genres=16`
      )
      .then((data) => {
    ...
    <div className={styles.category}>
      ...
      <div className={styles.subcategories}>
        ...
        <Link to={"/category/science"}>
          <p className={styles.active}>science fiction</p>
        </Link>
